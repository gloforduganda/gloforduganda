...
const variantStyles: Record<ToastVariant, string> = {
  default:
    "border-[var(--color-border)] bg-[var(--color-card)] text-[var(--color-card-fg)]",
  success:
    "border-[var(--color-success)] bg-[var(--color-success)] text-[var(--color-success-fg)]",
  danger:
    "border-[var(--color-danger)] bg-[var(--color-danger)] text-[var(--color-danger-fg)]",
};
...
>(({ className, variant = "default", ...props }, ref) => (
  <ToastPrimitive.Root
    ref={ref}
    className={cn(
      "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-[var(--radius-md)] border p-4 shadow-lg transition-all",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-[var(--radius-md)] border border-[var(--color-border)] bg-transparent px-3 text-sm font-medium transition-colors",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-[var(--radius-md)] p-1 opacity-0 transition-opacity",
