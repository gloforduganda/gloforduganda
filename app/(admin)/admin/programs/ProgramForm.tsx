    ...
    <div className="grid min-w-0 gap-6 lg:grid-cols-[1fr_280px]">
      <div className="space-y-6">
        <section className="rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-card)] p-5 space-y-4">
          ...
          <Field label="Title">
            <input value={title} onChange={(e) => setTitle(e.target.value)} placeholder="e.g. Youth Empowerment" className={inputCls} />
          </Field>
          <Field label="Slug">
            <input value={slug} onChange={(e) => setSlug(e.target.value)} placeholder="e.g. youth-empowerment" className={inputCls} />
          </Field>
          <Field label="Summary" hint="Short description shown in listings">
            <Textarea value={summary} onChange={(e) => setSummary(e.target.value)} rows={3} placeholder="A short description shown in program listings and search results..." className={inputCls} />
          </Field>
